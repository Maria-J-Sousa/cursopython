...
WIDTH, HEIGHT = 1000, 750  # Aumentado para incluir o mapa
...
# Banco de palavras sobre o Brasil (aumentado)
palavras_dicas = {
    ...
    "cuiabá": ["Capital do Mato Grosso", "Conhecida como 'cidade verde'", "Porta de entrada para o Pantanal"],
    "pelé": ["Maior jogador de futebol da história", "Único tricampeão mundial", "Marcou 1.281 gols em 1.363 jogos"],
    "tietê": ["Rio mais importante de São Paulo", "Tem 1.100 km de extensão", "Atravessa toda a capital paulista"],
    "bumba meu boi": ["Festividade típica do nordeste", "Mistura dança, música e teatro", "Patrimônio Cultural do Brasil"],
    "cachaça": ["Bebida destilada da cana-de-açúcar", "Brasil produz 1,5 bilhão de litros/ano", "Ingrediente principal da caipirinha"],
    "fernando de noronha": ["Arquipélago com 21 ilhas", "Vida marinha com 230 espécies", "Considerado um dos melhores locais para mergulho"],
    "cristo redentor": ["Estátua tem 30 metros de altura", "Pesa 1.145 toneladas", "Eleita uma das 7 maravilhas do mundo moderno"],
    "inconfidência mineira": ["Movimento pela independência", "Ocorreu em 1789 em Minas Gerais", "Tiradentes foi seu principal líder"],
    "literatura de cordel": ["Poesia popular do nordeste", "Originada no século XIX", "Exposta em folhetos pendurados em cordas"],
    "feijoada": ["Prato considerado o nacional", "Surgiu nas senzalas no século XIX", "Tradicionalmente servida às quartas e sábados"],
    "sertanejo": ["Gênero musical mais ouvido", "Representa 30% do mercado fonográfico", "Tem raízes na música caipira"],
    "biquini": ["Praia mais famosa de Salvador", "Tem 500 metros de extensão", "Considerada uma das melhores praias urbanas"],
    "maracanã": ["Maior estádio do Brasil", "Já recebeu 200 mil espectadores", "Palco da final da Copa de 1950"],
    "itamaraty": ["Sede do Ministério das Relações Exteriores", "Projetado por Oscar Niemeyer", "Considerado obra-prima da arquitetura moderna"],
    "ouro preto": ["Cidade histórica de Minas Gerais", "Patrimônio Cultural da Humanidade", "Foi capital de Minas Gerais no século XVIII"]
}
...
def desenhar_mapa_brasil():
    """Desenha um mapa simplificado do Brasil no rodapé"""
    # Coordenadas aproximadas do contorno do Brasil
    pontos = [
        (150, 650), (160, 640), (170, 630), (180, 620), (200, 610),
        (220, 600), (240, 590), (260, 580), (280, 570), (300, 560),
        (320, 550), (340, 540), (360, 530), (380, 520), (400, 510),
        (420, 500), (440, 490), (460, 480), (480, 470), (500, 460),
        (520, 450), (540, 440), (560, 430), (580, 420), (600, 410),
        (620, 400), (640, 390), (660, 380), (680, 370), (700, 360),
        (720, 350), (740, 340), (760, 330), (780, 340), (800, 350),
        (820, 360), (840, 370), (860, 380), (880, 390), (900, 400),
        (920, 410), (940, 420), (960, 430), (980, 440), (1000, 450),
        (980, 460), (960, 470), (940, 480), (920, 490), (900, 500),
        (880, 510), (860, 520), (840, 530), (820, 540), (800, 550),
        (780, 560), (760, 570), (740, 580), (720, 590), (700, 600),
        (680, 610), (660, 620), (640, 630), (620, 640), (600, 650),
        (580, 660), (560, 670), (540, 680), (520, 690), (500, 700),
        (480, 710), (460, 720), (440, 730), (420, 740), (400, 750),
        (380, 740), (360, 730), (340, 720), (320, 710), (300, 700),
        (280, 690), (260, 680), (240, 670), (220, 660), (200, 650),
        (180, 640), (160, 630), (140, 620), (120, 610), (100, 600),
        (80, 590), (60, 580), (40, 570), (20, 560), (0, 550),
        (20, 540), (40, 530), (60, 520), (80, 510), (100, 500),
        (120, 490), (140, 480), (160, 470), (180, 460), (200, 450),
        (220, 440), (240, 430), (260, 420), (280, 410), (300, 400),
        (320, 390), (340, 380), (360, 370), (380, 360), (400, 350),
        (420, 340), (440, 330), (460, 320), (480, 310), (500, 300),
        (480, 290), (460, 280), (440, 270), (420, 260), (400, 250),
        (380, 240), (360, 230), (340, 220), (320, 210), (300, 200),
        (280, 190), (260, 180), (240, 170), (220, 160), (200, 150),
        (180, 140), (160, 130), (140, 120), (120, 110), (100, 100),
        (80, 90), (60, 80), (40, 70), (20, 60), (0, 50),
        (20, 40), (40, 30), (60, 20), (80, 10), (100, 0),
        (120, 10), (140, 20), (160, 30), (180, 40), (200, 50),
        (220, 60), (240, 70), (260, 80), (280, 90), (300, 100),
        (320, 110), (340, 120), (360, 130), (380, 140), (400, 150),
        (420, 160), (440, 170), (460, 180), (480, 190), (500, 200),
        (520, 210), (540, 220), (560, 230), (580, 240), (600, 250),
        (620, 260), (640, 270), (660, 280), (680, 290), (700, 300),
        (720, 310), (740, 320), (760, 330), (780, 340), (800, 350)
    ]
    
    # Desenha o contorno do Brasil
    if len(pontos) > 1:
        pygame.draw.polygon(screen, BRASIL_GREEN, pontos)
        pygame.draw.polygon(screen, (0, 80, 0), pontos, 2)  # Borda mais escura
...
def tela_inicial(placar):
    while True:
        ...
        # Mapa do Brasil no rodapé
        desenhar_mapa_brasil()
